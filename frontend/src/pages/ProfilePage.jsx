...
import { Package, Heart, User, LogOut, ChevronRight, MapPin, CreditCard, ShoppingBag, Eye } from 'lucide-react';
...
const mockOrders = [
    {
        ...
        total: 125,
        items: [
            { name: "T-shirt Vintage Premium", quantity: 2, price: 45, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" },
            { name: "Casquette Noire", quantity: 1, price: 35, image: "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" }
        ]
    },
    {
        id: "ORD-2023-1005",
        ...
        total: 89,
        items: [
            { name: "Jean Slim Fit", quantity: 1, price: 89, image: "https://images.unsplash.com/photo-1542272454315-4c01d7abdf4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" }
        ]
    }
];
                    ...
                    {activeTab === 'profile' && (
                        <div className="animate-fade-in">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-8 text-center mb-8">
                                ...
                                <p className="text-gray-500 mb-6">john.doe@example.com</p>
                        ...
                        <div className="animate-fade-in">
                            ...
                            <div className="space-y-6">
                                {mockOrders.map(order => (
                                    <div key={order.id} className="bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition border border-transparent hover:border-gray-200">
                                        <div className="flex flex-wrap justify-between items-start gap-4 mb-4 pb-4 border-b border-gray-100">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-bold text-primary">{order.total} TND</p>
                                            </div>
                                            ...
                                            {order.items.map((item, idx) => (
                                                <div key={idx} className="flex items-center gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-xs text-gray-500">Qté: {item.quantity} x {item.price} TND</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
