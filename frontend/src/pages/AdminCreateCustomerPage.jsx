...
const AdminCreateCustomerPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(`Customer "${formData.name}" created successfully with email: ${formData.email}`);
            setFormData({
                name: '',
                email: '',
                password: '',
    ...
    return (
        <div className="p-8 bg-slate-900 min-h-screen">
            <div className="max-w-2xl mx-auto">
                <h1 className="text-3xl font-bold text-white mb-8">Create New Customer</h1>
